<?
	...
	$languageId = $user->getSettings()->languageId;

	// и языковые данные для сайта
	$speech = getLang($languageId);
			...
			<div class="dog-page<?=($isFixedHead ? " dog-page-fixed": "");?>" id="wrap-content">
				<div class="dog-menu" id="dog-menu">
					...
					<div class="footer">
						...
						<br />
						<a href="/migrate.php">Вернуться на v6.4</a>
					</div>
				</div>
