...
function initStatYandexMetrika() {
	(function (d,w,c){(w[c]=w[c]||[]).push(function(){try{w.yaCounter19029880=new Ya.Metrika({id:19029880,trackHash:!0})}catch(e){}});var n=d.getElementsByTagName("script")[0],s=d.createElement("script"),f=function(){n.parentNode.insertBefore(s,n);};s.type="text/javascript";s.async=!0;s.src="https://cdn.jsdelivr.net/npm/yandex-metrica-watch/watch.js";if(w.opera==="[object Opera]")d.addEventListener("DOMContentLoaded",f,!1);else f()})(document,window,"yandex_metrika_callbacks");
}
...
function createInputDate(options, date) {
	...
	wrap = e("div", {"class": "ui-dateChooser", append: [
		...
		y = getSelectNumbersInRange({
			...
			onchange: recount
		}, u.getFullYear(), u.getFullYear() + 1, u.getFullYear()),
